...
class ReportCard extends Component {
  ...
  componentDidMount() {
      console.log("here")
    fetch(CORS+API + this.state.memId + "&membershipType="+this.state.memType)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{this.state.profileData.stats.playtime.value/3600} hours</td>
      <td>{this.state.profileData.stats.playtime.avg/3600} hours</td>
    </tr>
    <tr>
      <td>&nbsp;PVE KD</td>
    ...
    <tr>
      ...
      <td>{this.state.profileData.stats.strikecompletions.grade}</td>
      <td>{this.state.profileData.stats.strikecompletions.value}</td>
      <td>{this.state.profileData.stats.strikecompletions.avg}</td>
    </tr>
    <tr>
      <td>&nbsp;NightFalls</td>
    ...
    <tr>
      <td>&nbsp;Public Events</td>
      <td>{this.state.profileData.stats.publicevents.grade}</td>
      <td>{this.state.profileData.stats.publicevents.value}</td>
    ...
    <tr>
      ...
      <td>{this.state.profileData.stats.CombatRatingPvP.grade}</td>
      <td>{this.state.profileData.stats.CombatRatingPvP.value}</td>
      <td>{this.state.profileData.stats.CombatRatingPvP.avg}</td>
    </tr>
	  <tr>
      <td>Trials Recod&nbsp;</td>
      <td>{this.state.profileData.stats.trialsRecord.grade}</td>
      <td>{this.state.profileData.stats.trialsRecord.value}</td>
      <td>{this.state.profileData.stats.trialsRecord.avg}</td>
    </tr>
	  <tr>
      <td>&nbsp;Triumph Score</td>
      <td>{this.state.profileData.stats.triumphscore.grade}</td>
      <td>{this.state.profileData.stats.triumphscore.value}</td>
      <td>{this.state.profileData.stats.triumphscore.avg}</td>
    </tr>
  </tbody>
</table>
                  
               <h2> Overall Grade: {this.state.profileData.playerInfo.averageGrade} </h2>
                </div>
              </Col>
              <Col lg={1}></Col>
            </Row>
