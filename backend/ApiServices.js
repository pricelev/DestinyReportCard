...
//returns an list of players with matching display names from destiny api based off parameter: name
 function findPlayer(name){
  let path = "https://www.bungie.net/platform/Destiny2/SearchDestinyPlayer/-1/" + name +"/";
   return axios({
    method: 'get',
    url: path,
...
function findProfile(memID,memType){
  let path ="https://www.bungie.net/Platform/Destiny2/"+memType+"/Profile/" + memID + "/?components=100";
  console.log(path);
  return axios({
    method: 'get',
    url: path,
...
function getPlayerStats(memID,memType){
  let path ="https://www.bungie.net/platform/Destiny2/"+memType+"/Account/"+memID+"/Stats/";
  return axios({
    method: 'get',
    url: path,
    headers: { 'Content-Type': 'application/json; charset=utf-8',
...
function getRecords(memID,memType){
  let path ="https://www.bungie.net/Platform/Destiny2/"+memType+"/Profile/" + memID + "/?components=900";
  return axios({
    method: 'get',
    url: path,
    headers: { 'Content-Type': 'application/json; charset=utf-8',
...
function getCharacterStats(memID,memType,charID){
  let path = "https://www.bungie.net/platform/Destiny2/"+memType+"/Account/"+memID+"/Character/"+charID+"/Stats/";
...
function getCharacterInfo(memID,memType,charID){
  let path = "https://www.bungie.net/platform/Destiny2/"+memType+"/Profile/"+memID+"/Character/"+charID+"/?components=200";
...
function getCharacterNightfall(memID,memType,charID){
  let path = 'https://www.bungie.net/platform/Destiny2/'+memType+'/Account/'+memID+'/Character/'+charID+'/Stats/?modes=46';
  return axios({
    method: 'get',
    url: path,
    headers: { 'Content-Type': 'application/json; charset=utf-8',
...
function getCharacterTrials(memID,memType,charID){
  let path = 'https://www.bungie.net/platform/Destiny2/'+memType+'/Account/'+memID+'/Character/'+charID+'/Stats/?modes=84';
  return axios({
    method: 'get',
    url: path,
    headers: { 'Content-Type': 'application/json; charset=utf-8',
